...
function trackClick(platform: string, location: string) {
    ...
    <div className="flex items-center gap-3">
      {configs.map((s) => (
        <a
          ...
          onClick={() => trackClick(s.platform, location)}
          className={`flex h-10 w-10 items-center justify-center rounded-full bg-zinc-900 text-zinc-400 transition-all ${s.hoverColor} hover:text-white`}
          aria-label={s.label}
        >
          {s.icon}
        </a>
      ...
      <div className="relative">
        {showWeChat && (
          <div className="absolute bottom-12 left-1/2 -translate-x-1/2 flex items-center gap-2 whitespace-nowrap rounded-xl bg-white px-4 py-3 shadow-2xl ring-1 ring-zinc-200">
        ...
        <button
          ...
          className="flex h-10 w-10 items-center justify-center rounded-full bg-zinc-900 text-zinc-400 transition-all hover:bg-[#07C160] hover:text-white"
